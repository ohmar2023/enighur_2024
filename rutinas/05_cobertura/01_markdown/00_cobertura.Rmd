...
\begin{titlepage}
  \begin{center}
    ...
    {\Large\bfseries \textcolor{trueblue} {Periodo de referencia: IX} \par}
    \vspace{1cm}
...
Se presenta la información de las tasas de conformidad desde el periodo 01 hasta el periodo `r periodo`. Los periodos más deficientes a nivel de cobertura son el 01 y el 02. El periodo 09 presenta una desmejora con respecto a la calidad de cobertura de los dos periodos que lo preceden.
