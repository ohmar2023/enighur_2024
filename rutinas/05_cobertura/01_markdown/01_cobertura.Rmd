...
\begin{titlepage}
  \begin{center}
    ...
    %{\Large \textcolor{trueblue}{Mayo 2025 } \par}
    
    \vfill
    
    {\large \textcolor{trueblue} {Junio - 2025}\par}
...
source("rutinas/05_cobertura/01_markdown/02_mapas.R")
```
...
\textcolor{trueblue}{\section{Control de cobertura de campo y muestral (Periodo `r periodo`)}}
